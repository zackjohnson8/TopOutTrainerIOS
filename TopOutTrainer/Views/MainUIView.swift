...
//    var buttonColors: [UIColor] = [UIColor.mainGreen(), UIColor.blue, UIColor.orange, UIColor.systemPink]
//    var buttons: [MainUIButton] = []
//
//    weak var delegate: MainUIViewDelegate?
//
//    enum ButtonType
...
//    }
//
//    required init(parent: MainViewController)
//    {
...
//        {
//            var newButton:MainUIButton? = nil
...
//                    newButton = MainUIButton(viewConstainer, buttonColors[index], .top, image)
//
...
//                    newButton = MainUIButton(viewConstainer, buttonColors[index], .bottom, image)
//
