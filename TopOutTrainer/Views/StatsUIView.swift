...
protocol StatsUIViewDelegate: AnyObject
{
...
class StatsUIView: UIView
{
    ...
    var buttonColors: [UIColor] = [UIColor.statsGreen(), UIColor.blue, UIColor.orange, UIColor.systemPink]
    var buttons: [StatsUIButton] = []
    
    weak var delegate: StatsUIViewDelegate?
    ...
    required init?(coder: NSCoder) {
        fatalError("Fatal error in StatsUIViewModel")
    }
    ...
    private func createButtons()
    {
        ...
        {
            var newButton:StatsUIButton? = nil
            ...
            if(index % 2 == 0)
            {
                if(rightVerticalStack.arrangedSubviews.count == 0)
                {
                    ...
                    newButton = StatsUIButton(viewConstainer, buttonColors[index], .top, image)
                ...
                }else
                {
                    ...
                    newButton = StatsUIButton(viewConstainer, buttonColors[index], .bottom, image)
